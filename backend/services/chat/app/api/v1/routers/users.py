...
@users_router.post(path=".users.me", status_code=status.HTTP_201_CREATED)
...
@users_router.get(path=".users.me.chats", status_code=status.HTTP_201_CREATED)
async def me_chats(
    user: UserSchema = Depends(get_user_request),
